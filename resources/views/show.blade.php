<x-app-layout>
        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="mx-4 w-full">
                ...
                <div class="text-gray-600 mt-3">
                    Lorem ipsum, dolor sit amet Lorem, ipsum dolor. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laudantium, magni aspernatur. Accusantium vitae maiores voluptatibus iusto illum cumque commodi laudantium minus, id quibusdam culpa tempora at voluptates ipsum totam tempore!
                </div>
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div x-data="{isOpen : false}"
                        ...
                        <div
                            ...
                            text-center w-28 h-7 py-2 px-4">Open</div>
                        <button
                            @click="isOpen = !isOpen"
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            <div
                ...
                <div
                    ...
                    <form action="" class="space-y-4 px-4 py-6">
                        <div>
                            <textarea name="post_comment" id="post_comment" cols="30" rows="4" class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2" placeholder="Go ahead, dont't be shy. Share your thoughts..."></textarea>
                        </div>
                        <div class="flex items-center space-x-3">
                            <button
                                type="button"
                                class="flex items-center justify-center w-1/2 h-11 text-sm bg-blue font-semibold rounded-xl border
                                border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-white"
                                >
                                Post Comment
                            </button>
            ...
            <div
                ...
                <button
                    type="button"
                    @click="isOpen = !isOpen"
                    class="flex items-center justify-center w-36 h-11 text-sm bg-gray-200 font-semibold rounded-xl border
                    border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3"
                >
                ...
                <div
                    ...
                    <form action="" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-purple border-none" name="status" value="1">
                                    <span class="ml-2">Considering</span>
                                </label>
                            </div>
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-yellow border-none" name="status" value="1">
                                    <span class="ml-2">In Progress</span>
                                </label>
                            </div>
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-green border-none" name="status" value="1">
                                    <span class="ml-2">Implemented</span>
                                </label>
                            </div>
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-red border-none" name="status" value="1">
        ...
        <div class="flex items-center space-x-3">
            ...
            <button
                type="button"
                class="w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl border uppercase
                border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3"
            >
                <span>Vote</span>
            </button>
    ...
    <div class="comments-container relative space-y-6 ml-22 my-8 pt-4 mt-1">
        <div class="comment-container bg-white rounded-xl flex mt-4">
            <div class="flex flex-1 px-4 py-6">
                <div class="flex-none">
                    <a href="#">
                        <img src="https://source.unsplash.com/200x200/?face=5" alt="avatar" class="w-14 ht-14 rounded-xl">
                    </a>
                </div>
                <div class="mx-4 w-full">
                    {{-- <h4 class="text-xl font-semibold">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div
                            ...
                            <button
                                @click="isOpen = !isOpen"
                                class="relative z-20 bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150 ease-in py-2 px-3 border">
                                <svg fill="currentColor" width="24" height="6"><path d="M2.97.061A2.969 2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0 100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97 2.97 0 10-.003 5.94A2.97 2.97 0 0021.03.06z" style="color: rgba(163, 163, 163, .5)"></svg>
                                <ul
                                    x-show="isOpen" x-transition.duration.500ms
                                    x-cloak
        ...
        <div class="is-admin comment-container  relative bg-white rounded-xl flex mt-4">
            <div class="flex flex-1 px-4 py-6">
                <div class="flex-none">
                    <a href="#">
                        <img src="https://source.unsplash.com/200x200/?face&v=3" alt="avatar" class="w-14 ht-14 rounded-xl">
                    </a>
        ...
        <div class="comment-container  relative bg-white rounded-xl flex mt-4">
            <div class="flex flex-1 px-4 py-6">
                <div class="flex-none">
                    <a href="#">
                        <img src="https://source.unsplash.com/200x200/?" alt="avatar" class="w-14 ht-14 rounded-xl">
                    </a>
                </div>
                <div class="mx-4 w-full">
                    {{-- <h4 class="text-xl font-semibold">
