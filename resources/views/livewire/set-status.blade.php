		...
		<form wire:submit.prevent="setStatus" action="#" class="space-y-4 px-4 py-6">
				<div class="space-y-2">
					<div>
						<label class="inline-flex items-center">
							<input wire:model="status" type="radio" checked class="bg-gray-200 text-gray-600 border-none" name="status" value="1">
				...
				<div class="flex items-center justify-between space-x-3">
					...
					<button
							...
							border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-white disabled:opacity-50"
						>
